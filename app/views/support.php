	...
	<?php switch($subtab) { 
	    case 'documentation': ?>
			<div class="thor-stuffbox" style="margin-top: 50px;">
				...
				<div class="inside">
					<iframe src="https://thunderbeardesign.com/productdocumentation/wp-thor-post-template/" width="100%" height="1000px"></iframe>
				</div>
			</div>
		<?php break; ?>	
	   <?php case 'debuginfo': ?>
			<div class="thor-stuffbox" style="margin-top: 50px;">
				...
				<div class="inside">
					...
					<?php if( isset($_POST['ok']) ) {
						$li = ThorCPTempAdmin::download_debuginfo_as_text();
						?>
						<div id="message" class="updated">
							<p><strong><?php _e('Debug info completed', 'fcm'); ?></strong></p>
					...
					<?php } ?>
						...
						<form method="post" action="#">
							...
							<p>
								<?php submit_button(__('Create Debug Info', 'fcm')); ?>
							</p>
						</form>
					</div>
				</div>
